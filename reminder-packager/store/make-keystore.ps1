...
#
# It will:
#   1) create sir-upload.jks (asks you for a password)
...
Set-Content -Path "sir-upload.jks.base64.txt" -Value $b64 -NoNewline
...
Write-Host ""
Write-Host "  ANDROID_KEYSTORE_BASE64   = (contents of sir-upload.jks.base64.txt in this folder)"
...
Write-Host ""
Write-Host "The base64 value is long. Open sir-upload.jks.base64.txt, press Ctrl+A then Ctrl+C, and paste."
